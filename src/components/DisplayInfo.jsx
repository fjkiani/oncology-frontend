...
const DisplayInfo = () => {
  ...
  useEffect(() => {
    // if (user) { // Comment out check for Privy user
      // Simulating fetching user data without Privy for now
      // Replace 'dummy@example.com' with actual user identification if available elsewhere
      const userEmail = 'dummy@example.com'; // Placeholder email
    ...
    // } // Comment out check for Privy user
  }, [fetchUserRecords, records, fetchUserByEmail]); // Remove user from dependency array
